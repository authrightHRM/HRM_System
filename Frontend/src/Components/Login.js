                            ...
                            <div className={classes.container}>
                                <form onSubmit={(event) => this.sendCredential(event)}>
                                    ...
                                    >
                                        ...
                                        />
                                        <FormHelperText id="weight-helper-text">Please input your password</FormHelperText>
                                    </FormControl>

                                    <Grid container spacing={24}>
                                        <Grid item xs={7}>
                                            {/* <AlertBox classes={classes} display={this.state.alert}>
                                            <small>Please log in before any action!</small>
                                                </AlertBox> */}
                                            <AlertBox classes={classes} display={this.state.loginError}>
                                                <small>Invalid username or password!</small>
                                            </AlertBox>
                                        </Grid>
                                        <Grid item xs={5}>
                                            <div className="forgetPassword" style={{ marginTop: 10, marginLeft: 0, textAlign: "right" }}>
                                                <Button onClick={this.handleClickOpen} style={{ fontSize: 10, color: "rgba(0,0,0,0.6)" }}>Forget Password ?</Button>
                                                <Dialog
                                          ...
                                          you an email with your password immediately.
                                        </DialogContentText>
                                                        <TextField
                                                            autoFocus
                                                            margin="dense"
                                    ...
                                    <div>
                                        <Button className={classes.button} raised color="primary" type="submit">Login</Button>
                                    </div>
                                </form>
                            </div>
                        </CardContent>
